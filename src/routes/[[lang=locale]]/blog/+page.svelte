...
<SEO
  ...
  description={t(locale, 'blog.meta_desc')}
  {locale}
/>
...
<PageHeader
  ...
  subtitle={t(locale, 'blog.page_subtitle')}
  breadcrumbs={[
    { label: t(locale, 'breadcrumbs.home'), href: localePath(locale, '/') },
    { label: t(locale, 'breadcrumbs.blog') }
  ]}
/>
